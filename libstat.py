...
class LibStat:
    ...
    def compare_common(self, lib_first: str, lib_sec: str):
        ...
        common_df.to_csv(f'{common_seq_dir}/{lib_first}_{lib_sec}.tsv', sep='\t', index=False)
        print(f'mean_C0_{lib_first}', common_df['C0x'].mean(), f'mean_C0_{lib_sec}', common_df['C0y'].mean())
