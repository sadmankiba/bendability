...
class Loops:
    ...
    """
    def __init__(self, chr: Chromosome, loop_file='data/input_data/loops/merged_loops_res_100_200_400_chrv.bedpe'):
        """
        Args:
    ...
    # *** #    
    def plot_mean_c0_across_loops(self, total_perc: int) -> None:
        """
